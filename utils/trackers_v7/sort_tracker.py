...
class SortTracker(object):
    def __init__(self, args, frame_rate=30):
        self.tracked_tracklets = []  # type: list[STrack]
        self.lost_tracklets = []  # type: list[STrack]
        self.removed_tracklets = []  # type: list[STrack]
    ...
    def update(self, output_results, img, ori_img):
        ...
        if len(dets) > 0:
            '''Detections'''
            # detections = [Tracklet(tlwh, s, cate) for
        ...
        unconfirmed = []
        tracked_tracklets = []  # type: list[STrack]
        ...
        dists = matching.iou_distance(tracklet_pool, detections)
