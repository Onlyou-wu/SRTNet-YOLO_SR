...
class BotTracker(object):
    def __init__(self, args, frame_rate=30):
        ...
        self.frame_id = 0
        self.args = args
        args.conf_thresh = args.track_thresh   #jia--lm
        ...
        from utils.trackers_v7.kalman_filters.botsort_kalman import BotKalman
        self.kalman_filter = BotKalman()
        ...
        #摄像机运动补偿模块
        self.gmc = GMC(method='None', downscale=1, verbose=None)
    ...
    def update(self, output_results, img, ori_img):
        ...
        output_results = output_results.cpu().numpy()  #jia--lm
        ...
        ious_dists = matching.iou_distance(tracklet_pool, detections)   #改
        ...
        for inew in u_detection:
            ...
            if track.score < self.det_thresh:
                continue
            track.activate(self.kalman_filter0, self.frame_id)
