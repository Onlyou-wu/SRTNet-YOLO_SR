...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'yolov9-s.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=ROOT /'models/detect/yolov9-s.yaml', help='model.yaml path')
    # parser.add_argument('--cfg', type=str, default=ROOT /'models/detect/yolov9-s-cot.yaml', help='model.yaml path')
